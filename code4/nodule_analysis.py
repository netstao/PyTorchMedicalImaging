...
logging.getLogger("code3.dsets").setLevel(logging.WARNING)
logging.getLogger("code4.dsets").setLevel(logging.WARNING)
...
class NoduleAnalysisApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('--segmentation-path',
            ...
            nargs='?',
            default='data/part/models/seg_2020-01-26_19.45.12_w4d3c1-bal_1_nodupe-label_pos-d1_fn8-adam.best.state',
        )
        ...
        parser.add_argument('--classification-path',
            ...
            nargs='?',
            default='data/part/models/cls_2020-02-06_14.16.55_final-nodule-nonnodule.best.state',
        )
    ...
    def initModelPath(self, type_str):
        local_path = os.path.join(
            ...
            'part',
            'models',
            'pytorch',#self.cli_args.tb_prefix,
    ...
    def initModels(self):
        ...
        model_cls = getattr(code4.model, self.cli_args.cls_model)
        cls_model = model_cls()
        ...
        if self.cli_args.malignancy_path:
            model_cls = getattr(code4.model, self.cli_args.malignancy_model)
